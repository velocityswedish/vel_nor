...
# HIGH CONTRAST gradients for ALL 25 categories (Norwegian names)
category_colors = {
    'Motivasjon': [(138, 43, 226), (75, 0, 130), (255, 20, 147), (147, 112, 219)],  # Purple → Pink
    'Kjærlighet': [(255, 0, 100), (139, 0, 0), (255, 105, 180), (255, 192, 203)],  # Red → Pink
    'Suksess': [(255, 215, 0), (0, 100, 0), (255, 140, 0), (34, 139, 34)],  # Gold → Green
    'Visdom': [(0, 0, 139), (255, 215, 0), (70, 130, 180), (255, 255, 0)],  # Blue → Yellow
    'Lykke': [(255, 255, 0), (255, 0, 255), (255, 165, 0), (147, 112, 219)],  # Yellow → Purple
    'Selvutvikling': [(0, 128, 0), (255, 215, 0), (0, 255, 0), (255, 140, 0)],  # Green → Gold
    'Takknemlighet': [(255, 127, 80), (75, 0, 130), (255, 160, 122), (138, 43, 226)],  # Coral → Purple
    'Vennskap': [(255, 192, 203), (0, 100, 80), (255, 105, 180), (0, 200, 160)],  # Pink → Teal
    'Håp': [(0, 0, 100), (255, 255, 0), (70, 130, 180), (255, 215, 0)],  # Blue → Yellow
    'Kreativitet': [(255, 0, 127), (0, 0, 139), (255, 20, 147), (75, 0, 130)],  # Pink → Blue
    'Indre Ro': [(135, 206, 235), (0, 0, 100), (176, 224, 230), (75, 0, 130)],  # Blue → Purple
    'Selvtillit': [(255, 69, 0), (0, 0, 139), (255, 140, 0), (70, 130, 180)],  # Orange → Blue
    'Utholdenhet': [(139, 69, 19), (255, 215, 0), (160, 82, 45), (255, 140, 0)],  # Brown → Gold
    'Inspirasjon': [(255, 0, 255), (75, 0, 130), (255, 20, 147), (0, 0, 139)],  # Magenta → Blue
    'Positivt Liv': [(50, 205, 50), (255, 0, 127), (144, 238, 144), (255, 20, 147)],  # Green → Pink
    'Mot': [(178, 34, 34), (255, 215, 0), (220, 20, 60), (255, 140, 0)],  # Red → Gold
    'Snillhet': [(255, 182, 193), (138, 43, 226), (255, 160, 122), (75, 0, 130)],  # Pink → Purple
    'Tålmod': [(34, 139, 34), (255, 255, 0), (60, 179, 113), (255, 215, 0)],  # Green → Yellow
    ...
    'Glede': [(255, 255, 0), (255, 0, 127), (255, 215, 0), (147, 112, 219)],  # Yellow → Purple
    'Balanse': [(60, 179, 113), (138, 43, 226), (152, 251, 152), (75, 0, 130)],  # Green → Purple
    'Vekst': [(0, 100, 0), (255, 215, 0), (34, 139, 34), (255, 140, 0)],  # Green → Gold
    'Formål': [(75, 0, 130), (255, 215, 0), (138, 43, 226), (255, 140, 0)],  # Purple → Gold
    'Aksomhet': [(210, 180, 140), (75, 0, 130), (245, 245, 220), (138, 43, 226)],  # Tan → Purple
}

all_categories = [
    'Motivasjon', 'Kjærlighet', 'Suksess', 'Visdom', 'Lykke',
    'Selvutvikling', 'Takknemlighet', 'Vennskap', 'Håp', 'Kreativitet',
    'Indre Ro', 'Selvtillit', 'Utholdenhet', 'Inspirasjon', 'Positivt Liv',
    'Mot', 'Snillhet', 'Tålmod', 'Tilgivelse', 'Styrke',
    'Glede', 'Balanse', 'Vekst', 'Formål', 'Aksomhet'
]
